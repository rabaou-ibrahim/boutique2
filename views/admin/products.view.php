    ...
    <div class="container">
        <aside>
            ...
            <div class="admin-buttons">
                ...
                <button class="users-btn"><a href="<?= URL ?>admin/vu">Gestion utilisateurs</a></button>
            </div>    
        </aside>
            ...
            <table class="table" id="table">
                <tr class="table-content" id="table-content">
                    ...
                    <div class="table-options">
                        ...
                        <td>
                            <form method="POST" action="<?= URL ?>admin/d/<?= $products[$i]->getId();?>" onSubmit = "return confirm('Confirmer suppression ?');">
